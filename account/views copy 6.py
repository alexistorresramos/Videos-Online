...
from .models import Book, Category, Videos_sold, Buyer
...
def buy_video(request):
    videotobuy=Book.objects.get(pk=24)
#    videotobuy.save()
    buyer= Buyer(news_name=request.user)
    print(request.user)
    print('uuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu')
    print(buyer.news_name)
    buyer.save()
    videotobuy.save()  
    print
    videotobuy.buyers.add(buyer)
 
    print('dddddddddddddddddddddddddddddddddddddddddd')
#    print(videotobuy.buyers.all())
    print(videotobuy.buyers)
#    videos = Book.objects.filter(buyers=3)
#    videos = Book.objects.get(pk=25)
#    videos = Book.objects.filter(buyers=6)  #no
    videos = Book.objects.get(buyers=6)
    videos.buyers.all()
#    print(videos.buyers.all())  # si
#    print(videos.buyers.filter(news_name=6))  # no 
#    print(videos.buyers.get(news_name=6))  # no    
    buy = Buyer.objects.get(pk=25) 
    buy.video_buyers.all()
    print(buy.video_buyers.all())
    print('eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee')


#    videos = Buyer.objects.get(news_name=6)
    videos = Buyer.objects.filter(news_name=request.user)
    print(videos)
#    videos.video_buyers.all()
#    videos = Book.objects.filter(buyers=3)
    return render(request,'course_details.html', {'videos': videos}) 
